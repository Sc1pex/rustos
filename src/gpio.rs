...
pub fn function(pin: u32, val: Function) {
    write(pin, val as u32, GPFSEL0, 3);
}

pub fn resistor(pin: u32, val: Resistor) {
    write(pin, val as u32, GPPUPDN0, 2);
}

pub fn set(pin: u32) {
    write(pin, 1, GPSET0, 1);
}

pub fn clear(pin: u32) {
    write(pin, 1, GPCLR0, 1);
}

pub fn write(pin: u32, val: u32, base: u32, field_size: u32) {
